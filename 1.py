...
write_button = tkinter.Button(window, text = 'Добавить задачу', background = 'red', command = do[1])
write_button.grid(row = 3, column = 1)

list_button = tkinter.Button(window, text = 'Список задач', background = 'red', command = do[2])
list_button.grid(row = 4, column = 1)

exit_button = tkinter.Button(window, text = 'Выход', background = 'red', command = do[3])
